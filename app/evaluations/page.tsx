...
import { HiArrowLeft, HiMagnifyingGlass, HiChevronUpDown, HiOutlineDocumentText, HiOutlineCalendar, HiOutlineTrophy } from "react-icons/hi2";
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                {data.map((analysis: AnalysisType) => (
                                    <Link key={analysis.id} href={`/evaluations/${analysis.id}`}>
                                        <div className="bg-white border border-gray-100 rounded-3xl p-6 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group flex flex-col h-full">
